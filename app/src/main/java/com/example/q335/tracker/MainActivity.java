                        ...
                        .setNeutralButton("Commands", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                try {
                                    ...
                                    Toast.makeText(context, "Commands exported to " + extStorPath + File.separator + COMMANDS_FILE, Toast.LENGTH_SHORT).show();
                                } catch (Exception e) {
                        ...
                        .setNegativeButton("Log entries", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                try {
                                    ...
                                    Toast.makeText(context, "Log entries exported to " + extStorPath + File.separator + LOG_FILE, Toast.LENGTH_SHORT).show();
                                } catch (Exception e) {
                                    Log.e("tracker:",e.toString());
                                    Toast.makeText(context, "Export failed. Does this app have storage permission? (Settings > Apps > tracker > Permissions)", Toast.LENGTH_LONG).show();
                                }
                        ...
                        .setPositiveButton("BOTH", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                try {
                                    copyFile(new File(getFilesDir(), "log.txt"), logFile);
                                    writeString(cmdFile, sprefs.getString("commands", ""));
                                    Toast.makeText(context, "Commands exported to " + extStorPath + File.separator + COMMANDS_FILE + System.getProperty("line.separator")
                                            + "Log entries exported to " + extStorPath + File.separator + LOG_FILE, Toast.LENGTH_LONG).show();
                                } catch (Exception e) {
                                    Log.e("tracker:",e.toString());
                                    Toast.makeText(context, "Export failed. Does this app have storage permission? (Settings > Apps > tracker > Permissions)", Toast.LENGTH_LONG).show();
                                }
